  ...
  return (
    (<LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-8xl font-medium tracking-tight text-transparent md:text-7xl">
        Here's Viraj <br /> Doing His best
      </motion.h1>
    </LampContainer>)
  );
}
