...
import { Img } from "react-image"; // Use the correct named export from react-image
...
export const Menu = ({
  ...
  return (
    (<nav
      ...
      className="relative rounded-full border border-transparent bg-slate-950 dark:border-white/[0.2]  shadow-input flex justify-center space-x-4 px-8 py-6 ">
      {children}
    </nav>)
  );
};
